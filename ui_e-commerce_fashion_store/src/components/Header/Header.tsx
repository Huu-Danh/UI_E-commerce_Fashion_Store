...
export default function Header() {
  ...
  return (
    <header className='relative w-full'>
      <div
        className={`fixed top-0 left-0 right-0 z-50 ${isScrolled ? 'bg-black/60 backdrop-blur-sm' : 'bg-transparent'}`}
      >
        <div className='max-w-7xl mx-auto flex items-center py-6 px-10 text-white'>
          ...
          <div className='flex-1 flex justify-end'>
            <ul className='flex gap-x-6 items-center'>
              ...
              <li>
                <button aria-label='Menu' className='flex items-center gap-1'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
